...
const MEMORY_INSTRUCTIONS = [
  ...
  '- User references previous work or asks to continue → recall_memory(session="last")',
  '- User asks about a past event, decision, or discussion → recall_memory(query="topic")',
  '- User mentions a specific time period → recall_memory(date="...")',
  '- Auto-injected context is insufficient → recall_memory for more detail',
  '- Unsure about something that was discussed before → search first, never guess.',
  '',
